...
public final class EasingUtil {
	...
	// Note: LibNolij defines a functional interface here, but FluxZoom doesn't use it.
	// Keeping it empty breaks compilation on older Java compilers, so it is removed.
